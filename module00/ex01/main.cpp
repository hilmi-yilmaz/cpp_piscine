...
int main() {
    ...
    std::string	first_name = "hilmicodamamsterdam";
    std::string	last_name = "yilmaz";
    std::string	nick_name = "gilmi";
    std::string	phone_number = "0611223344";
    std::string	darkest_secret = "yo";
